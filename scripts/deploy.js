...
async function main() {
  ...
  try {
    ...
    console.log("1️⃣  Deploying VillageToken...");
    ...
    const savingsGroupsContract = await ethers.getContractAt("SavingsGroups", savingsGroupsAddress);
    const microloanSystemContract = await ethers.getContractAt("MicroloanSystem", microloanSystemAddress);
    ...
    await villageTokenContract.mint(deployer.address, initialMint, gasOptions);
